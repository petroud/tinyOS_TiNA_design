...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7fe5e5758cf8, const void *arg_0x7fe5e5757020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7fe5e56d7618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fe5e548e020), 
int (*key_eq_fn)(void *arg_0x7fe5e548e798, void *arg_0x7fe5e548ea38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fe5e528a610, int arg_0x7fe5e528a878);
static double RandomUniform(void );
...
#line 461
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(68U, "Routing", "RoutingMsg enqueue failed!!! \n");
    }
...
static inline message_t *SRTreeC__DistributionReceive__receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  sim_log_debug(69U, "Distribution", "ID [%d]: Data Distribution package receivede from Node [%d]\n", TOS_NODE_ID, msource);
...
#line 488
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(70U, "SRTreeC", "DistributionMsg enqueue failed!!! \n");
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fe5e4e31a90, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fe5e4e31a90) {
#line 78
    case 22:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fe5e4e31a90, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fe5e4e30670, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fe5e4e30670, msg, payload, len);
#line 78
...
static inline void SRTreeC__sendRoutingTask__runTask(void )
{
  ...
  sim_log_debug(71U, "Routing", "SendRoutingTask(): Starting....\n");

  if (SRTreeC__RoutingSendQueue__empty()) 
    {
      sim_log_debug(72U, "Routing", "sendRoutingTask(): Q is empty!\n");
      return;
    }
  ...
  if (SRTreeC__RoutingSendBusy[sim_node()]) 
    {
      sim_log_debug(73U, "Routing", "sendRoutingTask(): RoutingSendBusy= TRUE!!!\n");
      return;
    }
  ...
  if (mlen != sizeof(RoutingMsg )) 
    {
      sim_log_debug(74U, "Routing", "\t\tsendRoutingTask(): Unknown message!!!\n");
      return;
    }
  ...
  if (sendDone == SUCCESS) 
    {
      sim_log_debug(75U, "Routing", "sendRoutingTask(): Send returned success!!!\n");
      SRTreeC__setRoutingSendBusy(TRUE);
    }
  else 
    {
      sim_log_debug(76U, "Routing", "send failed!!!\n");
    }
}
...
static inline void SRTreeC__receiveRoutingTask__runTask(void )
{
  ...
  sim_log_debug(99U, "Routing", "ReceiveRoutingTask(): len=%u \n", len);
  ...
  if (len == sizeof(RoutingMsg )) 
      ...
      if (SRTreeC__parentID[sim_node()] < 0 || SRTreeC__parentID[sim_node()] >= 65535) 
        {
          ...
          sim_log_debug(102U, "RoutingRes", "New parent for NodeID= %d : curdepth= %d , parentID= %d \n", TOS_NODE_ID, SRTreeC__curdepth[sim_node()], SRTreeC__parentID[sim_node()]);
    ...
    {
      sim_log_debug(103U, "Routing", "receiveRoutingTask():Empty message!!! \n");
      return;
    }
}
...
static inline void SRTreeC__sendDistributionTask__runTask(void )
{
  ...
  sim_log_debug(77U, "TinaRuntime", "TCT is %f\n", tctNumeric);

  sim_log_debug(78U, "TinaRuntime", "Will be executing measurement distribution...\n");

  if (SRTreeC__DistributionSendQueue__empty()) {
      sim_log_debug(79U, "TinaRuntime", "sendDistributionTask(): Q is empty!\n");
      return;
    }

  if (SRTreeC__DistributionSendBusy[sim_node()]) {
      sim_log_debug(80U, "TinaRuntime", "sendDistributionTask(): Distribution  Q is busy!...");
      return;
    }
  ...
  if (mLen != sizeof(BufferMsg )) {
      sim_log_debug(81U, "TinaRuntime", "sendDistributionTask(): Unknown message!\n");
      return;
    }
  ...
  if (SRTreeC__aggregateSelection[sim_node()] == MAX || SRTreeC__aggregateSelection[sim_node()] == COUNT) {
      ...
      if (msg == (void *)0) {
          sim_log_debug(82U, "TinaRuntime", "sendDistributionTask(): Na valid payload for SingleMsg!\nAbort..\n");
          return;
        }
      ...
      if (SRTreeC__aggregateSelection[sim_node()] == MAX) {
          ...
          if (TOS_NODE_ID == 0) {
              sim_log_debug(83U, "TinaMeasurements", "Node [%d] --> For this round MAX()= %d\n", TOS_NODE_ID, result);
            }
        }
      else {
#line 643
        if (SRTreeC__aggregateSelection[sim_node()] == COUNT) {
            ...
            if (TOS_NODE_ID == 0) {
                sim_log_debug(84U, "TinaMeasurements", "Node [%d] --> For this round COUNT()= %d\n", TOS_NODE_ID, result);
              }
          }
        }
      ...
      if (TOS_NODE_ID != 0) {
          ...
          if ((SRTreeC__roundCounter[sim_node()] == 1 || result > SRTreeC__lastAggregate[sim_node()] + tctNumeric * SRTreeC__lastAggregate[sim_node()]) || result < SRTreeC__lastAggregate[sim_node()] - tctNumeric * SRTreeC__lastAggregate[sim_node()]) {
              ...
              sim_log_debug(85U, "TinaMeasurements", "Node [%d] --> Over-TCT measurements: Last= %d| New= %d ==>Transmitting...\n", TOS_NODE_ID, SRTreeC__lastAggregate[sim_node()], result);
...
#line 677
              ...
              sim_log_debug(86U, "TinaMeasurements", "Node [%d] --> Under-TCT measurements: Last= %d| New= %d\n", TOS_NODE_ID, SRTreeC__lastAggregate[sim_node()], result);
              return;
            }
        }
    }
...
#line 701
        ...
        if (TOS_NODE_ID == 0) {
            sim_log_debug(87U, "TinaMeasurements", "Node [0] --> For this round MAX()= %d\n", resultMAX);
            sim_log_debug(88U, "TinaMeasurements", "Node [0] --> For this round COUNT()= %d\n", resultCOUNT);
          }
        else 
#line 717
          {
            ...
            if (SRTreeC__roundCounter[sim_node()] == 1 || ((resultMAX > SRTreeC__lastAggregateMAX[sim_node()] + tctNumeric * SRTreeC__lastAggregateMAX[sim_node()] || resultMAX < SRTreeC__lastAggregateMAX[sim_node()] - tctNumeric * SRTreeC__lastAggregateMAX[sim_node()]) && (resultCOUNT > SRTreeC__lastAggregateCOUNT[sim_node()] + tctNumeric * SRTreeC__lastAggregateCOUNT[sim_node()] || resultCOUNT < SRTreeC__lastAggregateCOUNT[sim_node()] - tctNumeric * SRTreeC__lastAggregateCOUNT[sim_node()]))) {
                ...
                sim_log_debug(89U, "TinaMeasurements", "ID:[%d] --> Over-TCT  MAX    measurements: Last= %d| New= %d ==>Transmitting...\n", TOS_NODE_ID, SRTreeC__lastAggregateMAX[sim_node()], resultMAX);
                sim_log_debug(90U, "TinaMeasurements", "ID:[%d] --> Over-TCT  COUNT  measurements: Last= %d| New= %d ==>Transmitting...\n", TOS_NODE_ID, SRTreeC__lastAggregateCOUNT[sim_node()], resultCOUNT);
...
#line 747
              ...
              if ((resultMAX > SRTreeC__lastAggregateMAX[sim_node()] + tctNumeric * SRTreeC__lastAggregateMAX[sim_node()] || resultMAX < SRTreeC__lastAggregateMAX[sim_node()] - tctNumeric * SRTreeC__lastAggregateMAX[sim_node()]) && (resultCOUNT < SRTreeC__lastAggregateCOUNT[sim_node()] + tctNumeric * SRTreeC__lastAggregateCOUNT[sim_node()] || resultCOUNT > SRTreeC__lastAggregateCOUNT[sim_node()] - tctNumeric * SRTreeC__lastAggregateCOUNT[sim_node()])) {
                  ...
                  sim_log_debug(91U, "TinaMeasurements", "ID:[%d] --> Over-TCT  MAX    measurements: Last= %d| New= %d ==>Transmitting...\n", TOS_NODE_ID, SRTreeC__lastAggregateMAX[sim_node()], resultMAX);
                  sim_log_debug(92U, "TinaMeasurements", "ID:[%d] --> Over-TCT  COUNT  measurements: Last= %d| New= %d \n", TOS_NODE_ID, SRTreeC__lastAggregateCOUNT[sim_node()], resultCOUNT);
...
#line 783
                  ...
                  sendDone = SRTreeC__DistributionAMSend__send(mDest, &SRTreeC__radioDistributionSendPkt[sim_node()], mLen);
                  if (sendDone == SUCCESS) {
                      sim_log_debug(93U, "SRTreeC", "MESSAGE SENT!!!!\n");
                    }
                }
              else {
#line 795
                if ((resultMAX < SRTreeC__lastAggregateMAX[sim_node()] + tctNumeric * SRTreeC__lastAggregateMAX[sim_node()] || resultMAX > SRTreeC__lastAggregateMAX[sim_node()] - tctNumeric * SRTreeC__lastAggregateMAX[sim_node()]) && (resultCOUNT > SRTreeC__lastAggregateCOUNT[sim_node()] + tctNumeric * SRTreeC__lastAggregateCOUNT[sim_node()] || resultCOUNT < SRTreeC__lastAggregateCOUNT[sim_node()] - tctNumeric * SRTreeC__lastAggregateCOUNT[sim_node()])) {
                    ...
                    sim_log_debug(94U, "TinaMeasurements", "ID:[%d] --> Over-TCT  MAX    measurements: Last= %d| New= %d \n", TOS_NODE_ID, SRTreeC__lastAggregateMAX[sim_node()], resultMAX);
                    sim_log_debug(95U, "TinaMeasurements", "ID:[%d] --> Over-TCT  COUNT  measurements: Last= %d| New= %d  ==>Transmitting...\n", TOS_NODE_ID, SRTreeC__lastAggregateCOUNT[sim_node()], resultCOUNT);
...
#line 823
                    ...
                    sim_log_debug(96U, "TinaMeasurements", "ID:[%d] --> Under-TCT   MAX    measurements: Last= %d| New= %d \n", TOS_NODE_ID, SRTreeC__lastAggregateMAX[sim_node()], resultMAX);
                    sim_log_debug(97U, "TinaMeasurements", "ID:[%d] --> Under-TCT   COUNT  measurements: Last= %d| New= %d \n", TOS_NODE_ID, SRTreeC__lastAggregateCOUNT[sim_node()], resultCOUNT);
                    return;
                  }
                }
              }
...
#line 836
      {
        sim_log_debug(98U, "TinaRuntime", "Bad Query !\nAbort...\n");
        return;
      }
    }
}
...
static inline void SRTreeC__receiveDistributionTask__runTask(void )
{
  ...
  sim_log_debug(104U, "Distribution", "receiveDistributionTask(): len=%u \n", len);
              ...
              for (i = 0; i < 64; i++) {
                  if (__nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].nodeID.nxdata) == msource || __nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].nodeID.nxdata) == 0) {
                      ...
                      if (aggrFlag == MAX) {
                          ...
                          sim_log_debug(108U, "TinaMeasurements", "ID:[%d] received from child [%d] MAX data = %d\n", TOS_NODE_ID, msource, __nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].maxVal.nxdata));
                        }
                      else {
#line 985
                        if (aggrFlag == COUNT) {
                            ...
                            sim_log_debug(109U, "TinaMeasurements", "ID:[%d] received from child [%d] COUNT data = %d\n", TOS_NODE_ID, msource, __nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].countVal.nxdata));
                          }
                        else {
                            sim_log_debug(110U, "Distribution", "receiveDistributionTask: Bad Aggr Flag...Aborting...\n");
                            return;
                          }
                        }
                    }
              ...
              sim_log_debug(111U, "Distribution", "receiveDistributionTask: Bad Message...Aborting...\n");
              return;
            }
          }
      }
...
#line 1004
      {
        sim_log_debug(112U, "TinaRuntime", "receiveDistributionTask: Bad Query...Aborting...\n");
        return;
      }
    }
}
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fe5e4e34970, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fe5e4e34970, msg, error);
#line 110
}
#line 110
...
#line 531
  ...
  sim_log_debug(173U, "CpmModelC", "ReadRssi: noise %f\n", noise);
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fe5e48bee18, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fe5e48bee18) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fe5e48bee18, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fe5e5164108){
#line 75
  switch (arg_0x7fe5e5164108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fe5e5164108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fe5e48bb020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fe5e48bb020, addr, msg, len);
#line 80
...
#line 269
  ...
  while (list != (void *)0) {
      sim_log_debug(148U, "CpmModelC", "checkReceive: outstanding from %d\n", list->source);
      count++;
  ...
  sim_log_debug(149U, "CpmModelC", "checkReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
...
#line 358
      ...
      sim_log_debug(156U, "CpmModelC,SNRLoss", "-signaling reception\n");
      CpmModelC__Model__receive(mine->msg);
      if (mine->ack) {
          sim_log_debug(157U, "CpmModelC", "yes acknowledgment requested, \n");
        }
      else {
          sim_log_debug(158U, "CpmModelC", "no acknowledgment requested.\n");
        }

      if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
          sim_log_debug(159U, "CpmModelC", " scheduling ack.\n");
          CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
        }
      else {
          sim_log_debug(160U, "CpmModelC", " should not ack.\n");
          CpmModelC__free_receive_message(mine);
        }
      ...
      if (RandomUniform() < 0.001) {
          sim_log_debug(161U, "CpmModelC,SNRLoss", "Packet was technically lost, but TOSSIM introduces an ack false positive rate.\n");
          if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
              sim_log_debug_clear(162U, "CpmModelC", " scheduling ack.\n");
              CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
            }
          else {
              CpmModelC__free_receive_message(mine);
      ...
      CpmModelC__receiving[sim_node()] = 0;
      sim_log_debug_clear(163U, "CpmModelC,SNRLoss", "  -packet was lost.\n");
    }
}
...
#line 407
  ...
  if (!sim_mote_is_on(sim_node())) {
      sim_log_debug(164U, "CpmModelC", "Lost packet from %i due to %i being off\n", source, sim_node());
      rcv->lost = 1;
    }
  else {
#line 430
    if (!CpmModelC__shouldReceive(power - noiseStr)) {
        sim_log_debug(165U, "CpmModelC,SNRLoss", "Lost packet from %i to %i due to SNR being too low (%i)\n", source, sim_node(), (int )(power - noiseStr));
        rcv->lost = 1;
      }
    else {
#line 434
...
#line 437
        if (CpmModelC__receiving[sim_node()]) {
            sim_log_debug(166U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-reception\n", source, sim_node());
            rcv->lost = 1;
          }
        else {
#line 441
          if (CpmModelC__transmitting[sim_node()] && rcv->start < CpmModelC__transmissionEndTime[sim_node()] && CpmModelC__transmissionEndTime[sim_node()] <= rcv->end) {
              sim_log_debug(167U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-transmission, transmissionEndTime %llu\n", source, sim_node(), CpmModelC__transmissionEndTime[sim_node()]);
              rcv->lost = 1;
            }
          else {
...
#line 449
  ...
  while (list != (void *)0) {
      ...
      if (!CpmModelC__shouldReceive(list->power - rcv->power)) {
          sim_log_debug(168U, "Gain,SNRLoss", "Going to lose packet from %i with signal %lf as am receiving a packet from %i with signal %lf\n", list->source, list->power, source, rcv->power);
          list->lost = 1;
        }
      list = list->next;
    }
...
#line 471
  sim_log_debug(169U, "CpmModelC", "Enqueing reception event for %i at %llu with power %lf.\n", dest, endTime, power);
  sim_set_node(dest);
...
#line 480
  ...
  sim_log_debug(170U, "CpmModelC", "Node %i transmitting to %i, finishes at %llu.\n", sim_node(), dest, endTime);
...
#line 487
  ...
  while (list != (void *)0) {
      list->lost = 1;
      sim_log_debug(171U, "CpmModelC,SNRLoss", "Lost packet from %i because %i has outstanding reception, startTime %llu endTime %llu\n", list->source, sim_node(), list->start, list->end);
      list = list->next;
    }
}
...
#line 500
{
  ...
  sim_log_debug(172U, "CpmModelC", "setPendingTransmission: transmitting %i @ %s\n", CpmModelC__transmitting[sim_node()], sim_time_string());
}
...
static inline void SRTreeC__RoutingMsgTimer__fired(void )
{
  ...
  if (SRTreeC__RoutingSendQueue__full()) 
    {
      sim_log_debug(58U, "Routing", "RoutingSendQueue is FULL!!! \n");
      return;
    }
  ...
  if (mrpkt == (void *)0) 
    {
      sim_log_debug(59U, "Routing", "RoutingMsgTimer.fired(): No valid payload... \n");
      return;
    }
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 321
...
#line 324
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(60U, "Routing", "RoutingMsg failed to be enqueued in SendingQueue!!!");
    }
}
...
#line 275
{
  ...
  if (TOS_NODE_ID == 0) {
      sim_log_debug(52U, "Rounds", "############################################\n");
      sim_log_debug(53U, "Rounds", "                  ROUND   %u                \n", SRTreeC__roundCounter[sim_node()]);
      sim_log_debug(54U, "Rounds", "############################################\n");
    }
}
...
#line 366
{
  ...
  sim_log_debug(61U, "Distribution", "Distribution Timer fired for Node [%d] at depth -%d-\n", TOS_NODE_ID, SRTreeC__curdepth[sim_node()]);
...
#line 379
  ...
  sim_log_debug(62U, "TinaMeasurements", "Node [%d] at depth -%d- measuring now: %d\n", TOS_NODE_ID, SRTreeC__curdepth[sim_node()], SRTreeC__currMeasurement[sim_node()]);




  if (SRTreeC__DistributionSendQueue__full()) {
      sim_log_debug(63U, "Distribution", "Distr Queue Full!!\nAbort...\n");
      return;
    }
  ...
  if (msg == (void *)0) {
      sim_log_debug(64U, "Distribution", "Payload Error!!\nAbort...\n");
      return;
    }
  ...
  if (enqueueDone == SUCCESS) {
      sim_log_debug(65U, "Distribution", "Provisioning distribution chain...\n");
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fe5e49662f8){
#line 83
  switch (arg_0x7fe5e49662f8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fe5e49662f8);
#line 83
      break;
#line 83
    }
...
#line 45
{
  sim_log_debug(113U, "PlatformC", "Initialized mote.\n");
  return SUCCESS;
}
  ...
  if (TOS_NODE_ID == 0) 
    {
      ...
      sim_log_debug(49U, "Tina", "Selected Aggregate Case: [%d] | Selected TCT Case: [%d] | Encoded bitwise to: [%u]\n", SRTreeC__aggregateSelection[sim_node()], SRTreeC__tct[sim_node()], SRTreeC__encodedParam[sim_node()]);
    }
  else 
    {
...
static void SRTreeC__DistributionAMSend__sendDone(message_t *msg, error_t err)
{
  sim_log_debug(67U, "Distribution", "A Data Distribution package sent... %s \n", err == SUCCESS ? "True" : "False");
...
static void SRTreeC__RoutingAMSend__sendDone(message_t *msg, error_t err)
{
  sim_log_debug(66U, "Routing", "Package sent %s \n", err == SUCCESS ? "True" : "False");
...
#line 294
  noise = pow(10.0, noise / 10.0);
  while (list != (void *)0) {
      sim_log_debug(150U, "CpmModelC", "packetReceive: outstanding from %d\n", list->source);
      count++;
  ...
  noise = 10.0 * log(noise) / log(10.0);
  sim_log_debug(151U, "CpmModelC", "packetReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
  return noise;
}
